...
な行お段及びわ行お段の上下に各種のダッシュとスラッシュを配置している。
...
> 和文ダッシュについては、JIS X 0213:2004からすると、U+2014にマッピングするほうが正しそうである。ただし、Adobe-Japan 1でU+2015に割り当てられた字形の方が和文用のダッシュに適しているようであることと、U+2015とすることによる弊害は少なそうであることから、U+2015に割り当てている。
